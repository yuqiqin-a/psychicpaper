---
{"dg-publish":true,"permalink":"/d-source/57uf/","dgHomeLink":true,"dgPassFrontmatter":false}
---
...
一般这样的问题会采用词型还原（[lemmatization](http://en.wikipedia.org/wiki/Lemmatisation)）或是词干还原（stemming）的方式进行。
...
4. 就算有用户发现mourning不是动名词，而是名词，或者发现全世界的统计方法都是mourn = 0，就我们是mourn = 1，我们也可以解释为计算方法不同；
5. 零频词过多学习体验不好
...
我和一个后端工程师同事做了一个demo尝试，效果非常令人堪忧：
1. quart把quarter加了进来
...
而这位产品关注的零频词数量，仅从原先的1500+减少到1400，更不用谈如果需要人工审核，需要白白浪费多少人力。

目前这个项目仍在进行中，有更新后会继续在此文章更新。
